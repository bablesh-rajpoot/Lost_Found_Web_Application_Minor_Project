<%-- 
    Document   : home
    Created on : Mar 13, 2019, 11:13:46 PM
    Author     : BABLESH RAJPOOT
--%>

<%@page import="java.util.ArrayList"%>
<%@page import="LostFound.dao.LostFoundDAO"%>
<%@page import="LostFound.dto.ReportsDTO"%>
...
<link rel="stylesheet" href="css/crdview.css" type="text/css"/>
            ...
            <div class="modal-content">
                          ...
                          <fieldset class="legend"><legend>FOR REPORT ARTICLE</legend>
                                  <div class="form-group">
                                    ...
                                    <div class="cuisine">
                                       ...
                                       <input type="text" name="category" id="cattype" placeholder="category">
                                       <br><span id="sp1"></span>
				    </div>
			 ...
			 <label for="recipient-name" class="col-form-label">Date of Missing :</label>
				...
				<span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
                                <input class="date" id="datepicker" name="date"  placeholder="dd/mm/yyyy"  type="text" onkeypress="return event.charCode>=48||47 && event.charCode<=57||47" maxlength="10">
                                <br><span id="sp3"></span>
			</div>
                            </div>    
                         ...
                         <div class="form-group"> <br>
                                  ...
                                  <div class="cuisine">
                                      ...
                                      <textarea id="description" name="description" placeholder="Description..." title="Please enter Your Queries"></textarea>	
                                      <br><span id="sp5"></span>
                                  </div>
                              </div>
                         <div class="form-group">
                                  <div class="cuisine">
                                      <img src="" id="upload" class='img-thumbnail' style='width:250px;height:150px' alt="lost" >
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Reward For Article (Optional):</label>
                              <div class="cuisine">
                                       ...
                                       <input type="text" name="reward" id="reward" placeholder=" 100.00" maxlength="10" onkeypress="return event.charCode>=48 && event.charCode<=57">
                                        <br><span id="sp7"></span>
				    </div>
                        </div>
                         </fieldset>
                        ...
                        <fieldset><legend>FOR PERSONAL INFORMATION</legend>
							...
							<span class="glyphicon glyphicon-earphone" aria-hidden="true"></span>
                                                        <input type="text" name="phone" id="phone" placeholder="Phone" maxlength="10" onkeypress="return event.charCode>=48 && event.charCode<=57">
                                                        <br><span id="sp9"></span>
				      </div>
				   ...
				   <div class="cuisine center-block">    	
                                       <input class="lostbtn" type="button" name="otpbtn" id="otpbtn" value="VARIFY OTP" onclick="connect1()">
				   ...
				   <div class="cuisine center-block">    	
                                       <input class="lostbtn" type="button" name="lostbtn" id="lostbtn" value="SUBMIT" onclick="connect()">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="exampleModalLabel2"><b>I LOST SOMETHING</b>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&Cross;</span>
                    </button></h4>
                </div>
			 ...
			 <label for="recipient-name" class="col-form-label">Date of Missing :</label>
				...
				<span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
				   ...
				   <div class="cuisine center-block">    	
                                       <input type="button" name="lostbtn" id="foundbtn" value="SUBMIT" onclick="connect()">
...
<!-- /About -->
    <section id="team" class="pb-5 ">
        ...
        <%
            ...
            ArrayList<ReportsDTO> al = LostFoundDAO.viewReports();
            for(ReportsDTO rp:al)
            {
                 String val="";
               if(rp.getReport_type().equalsIgnoreCase("Lost"))
              val = "I FOUND THIS";
               else
                  val = "I LOST THIS"; 
   ...
   "<p><img class='img-fluid img-thumbnail rounded float-left '   src='images/"+rp.getArticle_img().trim() +"' alt='card image'></p>"+
     " <p class='card-text textst' style='margin-top:40px'>"+ rp.getItem_reward()+ "</p>"+
  ...
  "<div class='card-body text-center mt-4'> "+
       " <h4 class='card-title'style='font-size: 1.6rem'>" + rp.getItem_Name()+"</h4>"+
   " <p class='card-text textst' style='margin-top:40px'>  Missing Place :" + rp.getMissing_place()+"</p>"+
    " <p class='card-text textst'> Missing Date :" +rp.getMissing_date() +"</p>"+
   " <p class='card-text textst' style='color:GREEN'>" + rp.getItem_desc()+"</p>"+
   
   "<button id = '"+rp.getReport_Id() +"class ='btn card-button' data-toggle='modal' data-backdrop='static'  data-target='#myModal' type=button>"+val+"</button>"+
...
<script type="text/javascript" src="js/otpsomething.js"></script>
